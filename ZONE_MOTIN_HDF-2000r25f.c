...
{
	real x_date[4] = { 7.70518959851007956274315802147612, 1.42911766252540406441084996913560, 0.31673262033468879694808606473089, 0.01427704241336671432682781102130  };
	x = x_date[0];
	ve = x_date[1];
	a = x_date[2];
	dx = x_date[3];
