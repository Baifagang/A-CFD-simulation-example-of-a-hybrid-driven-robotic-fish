...
{
	real x_date[4] = { 0.18686493169446269368982882497221, 0.31151209069342494784038422039885, 0.25090070980778522713450229275622, 0.00310190378956496769918826927892 };
	x = x_date[0];
	ve = x_date[1];
	a = x_date[2];
	dx = x_date[3];
