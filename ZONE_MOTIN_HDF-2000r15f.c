...
{
	real x_date[4] = { 6.32656781393528344636933979927562, 1.33036976678838780863145530020120, 0.18372056312178094983345033597288, 0.01329473589246951865938672909806  };
	x = x_date[0];
	ve = x_date[1];
	a = x_date[2];
	dx = x_date[3];
