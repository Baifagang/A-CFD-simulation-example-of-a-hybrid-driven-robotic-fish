...
{
	real x_date[4] = { 5.45966758562381748731695552123711, 1.56929403286724467037061003793497, -0.11592146050123257328134940280506, 0.00784820519483190280618511991406 };
	x = x_date[0];
	ve = x_date[1];
	a = x_date[2];
	dx = x_date[3];
