...
{
	real x_date[4] = { 7.22806213934107510965532128466293, 1.37538120473429725798553135973634, -0.31456148638422093410937918633863, 0.01376750803075755570648031067549 };
	x = x_date[0];
	ve = x_date[1];
	a = x_date[2];
	dx = x_date[3];
