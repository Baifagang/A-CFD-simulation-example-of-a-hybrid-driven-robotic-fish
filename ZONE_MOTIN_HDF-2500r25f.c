...
{
	real x_date[4] = { 7.71665796021246652713898583897389, 1.70937266404234744499035514309071, -0.34611669351682489148558374836284, 0.00855152372382646415449602983472 };
	x = x_date[0];
	ve = x_date[1];
	a = x_date[2];
	dx = x_date[3];
