...
{
	real x_date[4] = { 6.50264080888135431735008751275018, 1.63015072582167697134991612983868, 0.32265339526095432320929035086010, 0.00814689887798160025655924698640  };
	x = x_date[0];
	ve = x_date[1];
	a = x_date[2];
	dx = x_date[3];
