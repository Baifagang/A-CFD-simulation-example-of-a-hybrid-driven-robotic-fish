...
{
	real x_date[4] = { 5.34124375188148459159265257767402, 1.54933579316533531766708620125428, 0.21640328394735805495052716196369, 0.00774397432692272482540607470014   };
	x = x_date[0];
	ve = x_date[1];
	a = x_date[2];
	dx = x_date[3];
